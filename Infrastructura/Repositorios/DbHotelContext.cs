...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DB_Hotel.mssql.somee.com; Database=DB_Hotel; user id=DiegoA543_SQLLogin_1;pwd=6j68kjp9ip; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Ciudad>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Ciudad__3213E83FD62FB952");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Habitaci__3213E83FAF6BE9BE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Hotel__3213E83FB703ABCA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Huesped__3213E83F1605B082");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Pais__3213E83F8CC5BAB9");
        ...
        {
            entity.HasKey(e => e.IdPerfil).HasName("PK__Perfil__1D1C8768EC9A6AAE");
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.Property(e => e.NmContectoEmergencia)
                .HasMaxLength(200)
                .IsUnicode(false)
                .HasColumnName("Nm_contecto_emergencia");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuarios__4E3E04AD909BD048");
